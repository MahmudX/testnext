const TechSlider = () => {
    ...
    return (
        <>
            ...
            <div className="py-10 px-5 md:px-20 bg-yellow">
                <span className="font-bold text-2xl md:text-[40px] text-khaki">Technologies We
                    <br />
                    Excel In <svg className="inline-block" width="30" height="10" viewBox="0 0 30 10" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <g id="Frame 83">
